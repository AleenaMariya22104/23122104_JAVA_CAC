...
public class LinePlot {
    public static void plotLine(List<List<String>> data, String age, String bmi) {
        // Extract values for x and y columns
        List<Double> xValues = extractNumericColumn(data, age);
        List<Double> yValues = extractNumericColumn(data, bmi);
    ...
    return values; // Ensure to return the list of values
}
